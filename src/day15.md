...
> **發布日期:** 2022-09-19 08:54:05  
> **原文連結:** [https://ithelp.ithome.com.tw/articles/10292606](https://ithelp.ithome.com.tw/articles/10292606)
...
在判別器我們是使用CNN將圖片從(batch\_size,3,96,96)慢慢的變小變成(batch\_size,1, 1, 1)，所以我們要在生成器做一個逆向的動作，將一個(batch\_size,輸入資料,1,1)放大到(3x96x96)。
