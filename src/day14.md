...
> **原文連結:** [https://ithelp.ithome.com.tw/articles/10292214](https://ithelp.ithome.com.tw/articles/10292214)
...
![](images/20152236jhU0FogypK.jpg)

那該怎麼取得動態的資料呢?我們需要去偽造一個AJAX的請求方式

首先我們先按下F12到NetWork的地方  
![](images/201522362ffaqYdFFu.jpg)

接下來在pixiv中點擊插畫  
![](images/20152236q1XMb4GvTj.jpg)

這時候就會看到NetWork中多出了許多資料，這些資料就是瀏覽器對網站使用的AJAX請求的方式  
![](images/20152236xmi9fCLroU.jpg)
...
![](images/20152236MLFFaHPjfs.jpg)  
這時候會看到我們關鍵字"hololive"，並且在其他的請求中沒有這個字，那就大致上確定是這個網址了

之後將頁面切換到headers來取得AJAX的URL，與請求的cookies(若沒有只能請求10頁)  
![](images/20152236VJV5Cte01K.jpg)

在網址中可以看到幾個參數word、order、mode、s\_mode、type、lang，在這邊我只看得懂word、type、lang這三個參數，所以我決定去找到其他標籤與分類的網址
...
我們來看看我們用requests.get(AJAX\_url)的結果，並通過JSON格式化工具來查看一下結構  
![](images/20152236Cd1nGyH3OL.jpg)
