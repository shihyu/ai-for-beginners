...
> **原文連結:** [https://ithelp.ithome.com.tw/articles/10289155](https://ithelp.ithome.com.tw/articles/10289155)
...
剛剛只讀取了data\_batch\_1這個檔案，但我們今天需要重複6次相同的動作，這時我們可以透過os.listdir讀取資料夾內容的名稱，並透過迴圈讀取資料。
...
可以知道資料集需要分成測試數據集與訓練數據集，在CIFAR10中test\_batch就是我們的訓練數據集，所以我們就能用if判斷該資料是訓練還是測試資料。
